              ...
              >
                <div className="relative z-10 flex h-full flex-1 flex-col">
                  <div className="flex items-center gap-2 sm:gap-3">
                    <span className="flex h-7 w-7 items-center justify-center rounded-[8px] bg-gradient-brand text-[11px] font-bold text-white sm:h-8 sm:w-8 sm:text-[13px]">
                      0{index + 1}
                    </span>
                  ...
                  <p className="mt-2 text-[12px] leading-[1.5] text-[#5C607A] sm:mt-4 sm:text-[15px] sm:leading-relaxed">
                    {step.description}
                  </p>
                </div>
              </article>
        ...
        <Container>
          <div className="grid items-start gap-4 sm:gap-12 lg:grid-cols-[1fr_2fr] lg:gap-16">
            <div className="lg:sticky lg:top-24">
              <div className="mb-3 inline-flex h-9 w-9 items-center justify-center rounded-[8px] border border-[#0B0E2C]/10 bg-[#FF6B2C]/10 text-[#FF6B2C] sm:mb-6 sm:h-14 sm:w-14">
            ...
            <div className="grid gap-2 sm:grid-cols-2 sm:gap-4">
              {BEFORE_TECH_SUPPORT.map((item, index) => (
                <article
                  key={index}
                  className="group relative flex flex-col overflow-hidden rounded-[8px] border border-[#0B0E2C]/10 bg-white p-2.5 shadow-[var(--card-shadow)] transition-all duration-300 hover:-translate-y-1 hover:border-[#0B0E2C]/20 hover:shadow-[var(--card-shadow-hover)] sm:p-6"
                  style={
                    {
