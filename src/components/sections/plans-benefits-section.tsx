      ...
      <Container className="py-16 sm:py-20 lg:py-24">
        <div className="grid items-start gap-10 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] lg:gap-14 xl:gap-16">
          <div className="lg:sticky lg:top-28">
            ...
            <p className="mt-4 text-sm font-semibold text-[#0B0E2C]">
          ...
          <ul className="grid gap-4 sm:grid-cols-2 sm:gap-5">
            {BENEFITS.map((benefit) => {
              ...
              return (
                <li
                  key={benefit.label}
                  className="group relative flex items-center gap-4 overflow-hidden rounded-[8px] border border-[#0B0E2C]/10 bg-white p-5 shadow-[var(--card-shadow)] transition-all duration-300 hover:-translate-y-1 hover:border-[#0B0E2C]/20 hover:shadow-[var(--card-shadow-hover)] sm:p-6"
                  style={
                    {
                ...
                >
                  <div className="relative z-10 flex w-full items-stretch gap-4">
                    ...
                    <div className="flex min-w-0 flex-1 items-center gap-4">
                      ...
                      <span className="min-w-0 flex-1 text-[15px] font-semibold leading-snug text-[#0B0E2C] sm:text-[16px]">
                        {benefit.label}
                      </span>
                      <Check
