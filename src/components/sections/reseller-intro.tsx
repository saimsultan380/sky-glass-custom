      ...
      <Container>
        <div className="grid gap-5 sm:gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          <div>
            ...
            <p className="mt-3 text-[13px] leading-[1.55] text-[#5C607A] sm:mt-8 sm:text-base sm:leading-[1.75]">
          ...
          <div>
            <div className="rounded-[8px] border border-[#0B0E2C]/10 bg-white p-3 shadow-[0_8px_30px_rgba(11,14,44,0.04)] sm:p-10">
              ...
              <div className="mt-3 rounded-[8px] bg-[#F5F5F7] p-3 sm:mt-8 sm:p-6">
                <p className="text-[12px] leading-[1.5] text-[#5C607A] sm:text-sm sm:leading-relaxed">
