            ...
            <table className="w-full min-w-[640px] border-collapse text-left">
              <thead>
                <tr className="border-b border-[#0B0E2C]/10">
                  <th className="bg-white px-4 py-3 text-[12px] font-semibold uppercase tracking-[0.08em] text-[#5C607A] sm:px-6 sm:py-5 sm:text-[14px]">
                    Feature
                  </th>
                  <th className="relative bg-white px-4 py-3 sm:px-6 sm:py-5">
                    <div
