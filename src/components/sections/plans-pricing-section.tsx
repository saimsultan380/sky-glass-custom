    ...
    >
      <Container className="py-10 sm:py-16 lg:py-24">
        <div className="mx-auto max-w-4xl text-center">
          <h2 className="text-[24px] font-bold leading-[1.15] tracking-tight text-[#0B0E2C] sm:text-4xl sm:leading-[1.12] lg:text-[48px]">
            Sky Glass IPTV
            <br className="hidden sm:block" />
            Subscription Plans
          </h2>
          <div className="mx-auto mt-4 max-w-3xl space-y-2.5 text-[14px] leading-[1.7] text-[#5C607A] sm:mt-6 sm:space-y-3 sm:text-base sm:leading-[1.8]">
        ...
        <div className="mt-6 flex justify-center sm:mt-10">
          <div className="inline-flex items-center rounded-full border border-[#0B0E2C]/10 bg-[#0B0E2C]/[0.02] p-1.5">
            <button
              ...
              className={cn(
                "rounded-full px-5 py-2 text-[13px] font-bold transition-all duration-200 sm:px-6 sm:py-2.5 sm:text-[14px]",
                planType === "Standard"
        ...
        <div className="mx-auto mt-5 max-w-3xl text-center sm:mt-8">
          <p className="text-[14px] leading-[1.7] text-[#5C607A] sm:text-base sm:leading-[1.8]">
            {planType === "Standard"
        ...
        <div className="mt-8 grid gap-4 sm:mt-12 sm:gap-8 md:grid-cols-2 lg:grid-cols-4">
          {plans.map((plan) => (
            <article
              key={`${planType}-${plan.name}`}
              className={cn(
                "group relative flex flex-col items-center overflow-hidden rounded-[8px] border bg-white p-4 text-center shadow-[0_4px_20px_rgba(11,14,44,0.04)] transition-all duration-300 hover:-translate-y-1 hover:border-[#0B0E2C]/20 hover:shadow-[0_8px_30px_rgba(11,14,44,0.08)] sm:p-8 lg:p-6 xl:p-8",
                plan.popular
            ...
            >
              ...
              <div className="mt-5 flex flex-col items-center sm:mt-8">
                ...
                <div className="mt-2 flex items-baseline justify-center">
                  <span className="text-[28px] font-bold leading-none tracking-tight text-gradient-brand sm:text-[36px] xl:text-[40px]">
                    £{plan.price}
                  </span>
                </div>
              ...
              <hr className="my-4 w-full border-[#0B0E2C]/10 sm:my-6" />

              <div className="mb-4 w-full text-left text-[14px] font-bold text-[#0B0E2C]">
                {planType} Plan Includes:
              </div>

              <ul className="flex w-full flex-1 flex-col items-start gap-2.5 text-left sm:gap-3">
              ...
              <Link
                href="/contact-us"
                className="mt-6 inline-flex min-h-[44px] w-full items-center justify-center whitespace-nowrap rounded-[8px] bg-gradient-brand px-3 py-2.5 text-[11px] font-bold uppercase tracking-wide text-white transition-opacity duration-150 hover:opacity-90 sm:mt-8 sm:px-4 sm:text-[12px]"
              >
