  ...
  return (
    ...
    >
      <Container className="py-6 sm:py-16 lg:py-24">
        ...
        {/* Bento Grid Layout */}
        <div className="mt-5 grid gap-2.5 sm:mt-16 sm:grid-cols-2 sm:gap-4 lg:grid-cols-3 lg:gap-6">
                  ...
                  >
                    <div className={cn("flex flex-col", isWide && "md:w-[45%] lg:w-[50%]")}>
                      <div className="flex items-center gap-2.5 sm:block">
                        ...
                        <h3 className="text-[15px] font-bold tracking-tight text-[#0B0E2C] sm:mt-5 sm:text-xl">
                          {feature.title}
                        </h3>
                      </div>
                      <div className="mt-2 space-y-1.5 text-[12px] leading-[1.5] text-[#5C607A] sm:mt-3 sm:space-y-3 sm:text-[15px] sm:leading-[1.75]">
        ...
        <div className="mt-5 flex justify-center sm:mt-12">
          <Link
            ...
            className="inline-flex min-h-[44px] w-full items-center justify-center gap-2 rounded-[12px] bg-gradient-brand px-8 py-2.5 text-[14px] font-semibold text-white transition-opacity duration-150 hover:opacity-90 sm:min-h-[48px] sm:w-auto sm:py-3 sm:text-[15px]"
          >
