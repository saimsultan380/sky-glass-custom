      ...
      <Container className="py-6 sm:py-20 lg:py-24">
        <div className="grid items-start gap-4 sm:gap-10 lg:grid-cols-[minmax(0,1fr)_minmax(0,1fr)] lg:gap-14 xl:gap-16">
          <div>
            ...
            <Link
              href="/contact-us"
              className="mt-4 inline-flex min-h-[44px] w-full items-center justify-center gap-2 rounded-[8px] bg-gradient-brand px-6 py-2.5 text-[13px] font-semibold text-white transition-opacity duration-150 hover:opacity-90 sm:mt-8 sm:min-h-[48px] sm:w-auto sm:py-3 sm:text-[14px]"
            >
          ...
          <div className="rounded-[8px] border border-[#0B0E2C]/10 bg-white p-3 shadow-[0_4px_20px_rgba(11,14,44,0.04),0_8px_24px_rgba(123,47,255,0.10)] sm:p-8">
            ...
            <ul className="mt-3 space-y-1.5 sm:mt-5 sm:space-y-3">
              {FACTORS.map((factor) => {
                ...
                return (
                  ...
                  >
                    <span
                      className="flex h-7 w-7 shrink-0 items-center justify-center rounded-[7px] sm:h-10 sm:w-10 sm:rounded-[8px]"
                      style={{
                        backgroundColor: `${factor.color}14`,
                        color: factor.color,
                      }}
                    >
                      <Icon className="h-3.5 w-3.5 sm:h-[18px] sm:w-[18px]" strokeWidth={1.75} aria-hidden />
                    </span>
