    ...
    >
      <Container className="py-16 sm:py-20 lg:py-24">
        ...
        <div className="mt-12 grid gap-10 lg:grid-cols-[0.8fr_1.2fr] lg:gap-16">
          <div className="group relative flex flex-col overflow-hidden rounded-[8px] border border-[#0B0E2C]/10 bg-white p-6 shadow-[0_4px_20px_rgba(11,14,44,0.04),0_8px_24px_rgba(255,107,44,0.10)] transition-all duration-300 sm:p-8">
          ...
          <div className="min-w-0">
            <h3 className="flex items-center gap-2 text-lg font-bold text-[#0B0E2C] sm:text-xl">
              Device Setup Overview
            </h3>
            <div className="mt-6 overflow-hidden rounded-[8px] border border-[#0B0E2C]/10">
              <div className="overflow-x-auto">
                <table className="w-full min-w-[500px] border-collapse text-left">
                  <thead>
                    <tr className="border-b border-[#0B0E2C]/10 bg-[rgba(11,14,44,0.02)]">
                      <th className="px-5 py-4 text-[13px] font-bold uppercase tracking-wide text-[#5C607A]">
                        Device
                      </th>
                      <th className="px-5 py-4 text-[13px] font-bold uppercase tracking-wide text-[#5C607A]">
                        Setup Method
                  ...
                  <tbody>
                    {OVERVIEW_ROWS.map((row, idx) => (
                      ...
                      >
                        <td className="px-5 py-4 text-[14px] font-semibold text-[#0B0E2C]">
                          {row.device}
                        </td>
                        <td className="px-5 py-4 text-[14px] text-[#5C607A]">
                          {row.method}
                        </td>
                      </tr>
                    ))}
            ...
            <p className="mt-5 flex items-start gap-2 text-[13px] text-[#5C607A]">
              <Info
                className="mt-0.5 h-4 w-4 shrink-0 text-[#7B2FFF]"
                strokeWidth={2}
              />
