...
export function ContactCta() {
  return (
    ...
    >
      <Container>
        <div className="mx-auto max-w-5xl rounded-[8px] border border-[#0B0E2C]/10 bg-[#F8FAFC] px-6 py-12 text-center sm:px-10 sm:py-16">
          ...
          <h2 className="mt-3 text-[28px] font-bold leading-[1.15] tracking-tight text-[#0B0E2C] sm:text-4xl sm:leading-[1.12] lg:text-[42px]">
            Contact <span className="text-gradient-brand">Sky Glass IPTV</span> Today
          </h2>

          <div className="mx-auto mt-5 max-w-3xl space-y-4 text-[15px] leading-[1.75] text-[#5C607A] sm:mt-6 sm:text-base sm:leading-[1.8]">
            <p>
              Whether you want to request a trial, compare subscription options, submit a reseller enquiry or receive setup assistance, the Sky Glass IPTV support team is ready to help.
            </p>
            <p>
              Provide your device information and a clear description of your enquiry so the team can direct you towards the appropriate solution.
            </p>
          </div>
          ...
          <div className="mt-8 flex flex-col items-stretch justify-center gap-3 sm:mt-10 sm:flex-row sm:items-center sm:gap-4">
            <Link
              href="#contact-form"
              className="inline-flex min-h-[48px] items-center justify-center gap-2 rounded-[8px] bg-gradient-brand px-6 py-3 text-[14px] font-semibold text-white transition-opacity duration-150 hover:opacity-90"
            >
            ...
            <Link
              href="#contact-form"
              className="border-gradient-brand inline-flex min-h-[48px] items-center justify-center gap-2 rounded-[8px] px-6 py-3 text-[14px] font-semibold text-[#0B0E2C] transition-opacity duration-150 hover:opacity-80 bg-white"
            >
              <MessageCircle
