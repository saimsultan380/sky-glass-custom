    ...
    >
      <Container className="py-10 sm:py-16 lg:py-24">
        <div className="grid items-start gap-4 sm:gap-10 lg:grid-cols-[minmax(0,1fr)_minmax(0,1fr)] lg:gap-14 xl:gap-16">
          ...
          <div className="rounded-[1px] bg-white p-5 shadow-[0_4px_20px_rgba(11,14,44,0.04),0_8px_24px_rgba(233,30,140,0.10)] sm:p-8">
            ...
            <ul className="mt-3 space-y-1.5 sm:mt-5 sm:space-y-3">
              {EVALUATE_ITEMS.map((item) => {
                ...
                return (
                  ...
                  >
                    <span
                      className="flex h-10 w-10 shrink-0 items-center justify-center rounded-[1px] sm:h-9 sm:w-9 sm:rounded-[1px]"
                      style={{
                        backgroundColor: `${item.color}14`,
                        color: item.color,
                      }}
                    >
                      <Icon className="h-4 w-4 sm:h-4 sm:w-4" strokeWidth={1.75} aria-hidden />
                    </span>
