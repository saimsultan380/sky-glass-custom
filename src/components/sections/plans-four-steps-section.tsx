                ...
                <div className="relative z-10 flex gap-2.5 sm:gap-4">
                  <div className="flex min-w-0 flex-1 items-start gap-2.5 sm:gap-5">
                    ...
                    <div className="min-w-0 flex-1">
                      <span className="text-[12px] font-bold tracking-[0.14em] text-gradient-brand sm:text-[12px]">
                        STEP {item.step}
                      </span>
                      <h3 className="mt-0.5 text-base font-bold tracking-tight text-[#0B0E2C] sm:mt-1.5 sm:text-xl">
                        {item.title}
                      </h3>
